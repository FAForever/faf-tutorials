...
FAF_TUT_FourLeaf_BO_Expansions_1 = "[{i TrainingOfficer}]: The empty starting psoitions function as expansions."
...
FAF_TUT_FourLeaf_BO_MidReclaim_1 = "[{i TrainingOfficer}]: How I told you earlier Four-Leaf Clover is all about the reclaim. There is a huge amount in the middle. Press 'Ctrl+Shift' after the cinematics end to see the values."
...
FAF_TUT_FourLeaf_BO_FirstEngineer = "[{i TrainingOfficer}]: The first engie builds the last of the core mexes followed by a hydro, an Air Facotry, 4 pgens and 4 Land Factories."
...
FAF_TUT_FourLeaf_BO_FourthEngineer = "[{i TrainingOfficer}]: Fourth engie will assists the first one with building your main base."
...
FAF_TUT_FourLeaf_BO_Powerspam_1 = "[{i TrainingOfficer}]: After your Land Factories are up, give one engie the order to build more pgens. The others can be send to front to reclaim wrecks after a fight or build radars."
...
FAF_TUT_Loki_BO_FourMexCorner = "[{i TrainingOfficer}]: Here in the corner is with 4 mexes the biggest expansion on your side of the map."
...
FAF_TUT_Loki_BO_Choke = "[{i TrainingOfficer}]: The direct path to the mainbase of your opponent is only a small choke. This is an obstacle for your armies, so better avoid it with bigger forces. If your units are split up by the terrain/buildings, the enemy will find it easy to destroy them."
FAF_TUT_Loki_BO_PlateauWest = "[{i TrainingOfficer}]: The main area where army manuevers will take place are these plateaus."
...
FAF_TUT_Loki_BO_InitialBO_2 = "[{i TrainingOfficer}]: After finishing all buildings the ACU will move to the Hillside Expansion and build a Land Factory there before moving futher to the north."
FAF_TUT_Loki_BO_InitialBO_3 = "[{i TrainingOfficer}]: The Factory builds 3 engineers (engies). Then 1 tank and 1 scouts to protect your expanding engies and/or for raiding enemy engis."
...
FAF_TUT_Loki_BO_FirstEngineer_2 = "[{i TrainingOfficer}]: After crossing the pond, build a Land Factory first to secure the expansion. In case your engineer gets killing it will be faster to rebuild it from that factory rather than having to send a new one from the main base."
...
FAF_TUT_Loki_BO_FourthEngineer = "[{i TrainingOfficer}]: Fourth engie expands east. It is likely, that this engie wont be able to secure the 3 mex expnasion, but you might get some mass before the enemy is there to destroy it."
...
FAF_TUT_SummerDuel_BO_StartPosition = "[{i TrainingOfficer}]: Your starting position has 4 Mass Extranctors (mex) and a close hydro."
...
FAF_TUT_SummerDuel_BO_ACURush_2 = "[{i TrainingOfficer}]: Therefore you send an early t1 landscout to the choke, as you will see in the buildorder. If the scout sees the ACU or gets killed you immideatly build a T1 Point Defense (PD) in your base, before building further factories."
...
FAF_TUT_SummerDuel_BO_LandFirst_2 = "[{i TrainingOfficer}]: The Land Factory builds 3 Enginners (engies), 1 tank, 2 Landscouts, 2 engis and then a mix of 2 tanks and 1 engie on repeat."
...
FAF_TUT_SummerDuel_BO_SecondEngineer_2 = "[{i TrainingOfficer}]: It's quite important to not lose this engie as the rocks give you good amout of mass. Your first tank will protect this engie."
...
FAF_TUT_SummerDuel_BO_SecondScout_1 = "[{i TrainingOfficer}]: The second scouts gets sent to the middle to spot an incoming ACU rush, as it was explained in the map info."
...
FAF_TUT_SummerDuel_BO_FourthEngineer = "[{i TrainingOfficer}]: The fourth engie will assists the first one with building your base."
...
FAF_TUT_SummerDuel_BO_DualTank = "[{i TrainingOfficer}]: The 2 tanks which are built now will protect the nothern choke."
...
FAF_TUT_SummerDuel_BO_FollowUp_2 = "[{i TrainingOfficer}]: However don't be tempted to upgrade a mex as it is a big investement, which could, done at the wrong time, delay your unit production and lose you the game. Better invest spare mass into more Land Factories and tanks. Good Luck commander!"
